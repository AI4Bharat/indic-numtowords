from indic_numtowords.sin.data.nums import DIRECT_DICT
from indic_numtowords.sin.data.nums import NUMBER_SCALE_DICT
from indic_numtowords.sin.data.nums import VARIATIONS_DICT
from indic_numtowords.sin.utils import combine
